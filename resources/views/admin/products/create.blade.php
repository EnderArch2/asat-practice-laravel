                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="buy_price" class="block font-medium text-sm text-gray-700">Buy Price
                                    (Modal)</label>
                                <input type="number" name="buy_price" id="buy_price" value="{{ old('buy_price') }}"
                        ...
                        <div class="mb-6 border-t pt-4 mt-4">
                            <label for="image" class="block font-medium text-sm text-gray-700">Product Image
                                (Optional)</label>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('admin.products.index') }}"
                                class="px-6 py-2 bg-[#eb1a1a] text-white rounded-md hover:bg-[#b61515] mr-4 font-bold transition duration-150">Cancel</a>
                            <button type="submit"
                                class="px-6 py-2 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 transition duration-150">
                                Save Product
                            </button>
                        </div>
                    </form>
